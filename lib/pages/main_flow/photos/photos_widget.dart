                                      ...
                                      return Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            ...
                                            _model.uploadMyFile =
                                                await HappyGoAPIGroup.mediaCall
                                                    .call(
                                              token: FFAppState().Token,
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        logFirebaseEvent('Button-acceptTemp_backend_call');
                        ...
                        logFirebaseEvent(
                            'Button-acceptTemp_update_widget_state');
                        ...
                        if ((_model.apiNextModule?.succeeded ?? true)) {
                          if (_model.nextSl == 'show_agreement') {
                            logFirebaseEvent('Button-acceptTemp_navigate_to');
                            ...
                            if (_model.nextSl == 'photos') {
                              ...
                              if (_model.nextSl == 'wire_card') {
                                ...
                                if (_model.nextSl == 'verification') {
                                  logFirebaseEvent(
                                      'Button-acceptTemp_backend_call');
                                  _model.apiResult6ag =
                          ...
                          logFirebaseEvent('Button-acceptTemp_show_snack_bar');
                          ...
                          logFirebaseEvent('Button-acceptTemp_wait__delay');
                          await Future.delayed(
