...
class PhotosModel extends FlutterFlowModel {
  ...
  // Stores action output result for [Backend Call - API (nextmodule)] action in Button-acceptTemp widget.
  ApiCallResponse? apiNextModule;
  // Stores action output result for [Backend Call - API (status)] action in Button-acceptTemp widget.
