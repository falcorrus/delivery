...
class _SigningSmsWidgetState extends State<SigningSmsWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      logFirebaseEvent('SigningSms_update_widget_state');
      ...
      _model.apiSend2EnterCode = await HappyGoAPIGroup.nextmoduleCall.call(
                                  ...
                                  child: InkWell(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        if ((_model.apiSendsms?.succeeded ??
                                            true)) {
                                          logFirebaseEvent(
                                              'Button-more_update_widget_state');
