...
/// Start HappyGo API Group Code

class HappyGoAPIGroup {
  static String baseUrl = 'https://crm.happy-go.ru/api/v1';
...
class AgentsCall {
  Future<ApiCallResponse> call() {
    return ApiManager.instance.makeApiCall(
      callName: 'agents ',
      apiUrl: '${HappyGoAPIGroup.baseUrl}/agents',
      callType: ApiCallType.GET,
      headers: {
        ...HappyGoAPIGroup.headers,
      },
      params: {},
      returnBody: true,
    ...
    final ffApiRequestBody = '''
{
  ...
  "password": "${password}"
    ...
    return ApiManager.instance.makeApiCall(
      callName: 'login',
      apiUrl: '${HappyGoAPIGroup.baseUrl}/login',
...
class UserCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      callName: 'user',
      apiUrl: '${HappyGoAPIGroup.baseUrl}/user',
      callType: ApiCallType.GET,
      headers: {
        ...HappyGoAPIGroup.headers,
...
class OrdersCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      callName: 'Orders',
      apiUrl: '${HappyGoAPIGroup.baseUrl}/orders/',
      callType: ApiCallType.GET,
      headers: {
        ...HappyGoAPIGroup.headers,
        'Authorization': 'Bearer ${token}',
...
class OrderCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      callName: 'order',
      apiUrl: '${HappyGoAPIGroup.baseUrl}/order/${slug}',
      callType: ApiCallType.GET,
      headers: {
        ...HappyGoAPIGroup.headers,
        'Authorization': 'Bearer ${token}',
...
class DeleteCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      callName: 'Delete',
      apiUrl: '${HappyGoAPIGroup.baseUrl}/order/${slug}/media/delete/${taskNo}',
      callType: ApiCallType.POST,
      headers: {
        ...HappyGoAPIGroup.headers,
        'Authorization': 'Bearer ${token}',
...
class MediaCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      callName: 'Media',
      apiUrl: '${HappyGoAPIGroup.baseUrl}/order/${slug}/media/${taskNo}',
      callType: ApiCallType.POST,
      headers: {
        ...HappyGoAPIGroup.headers,
        'Authorization': 'Bearer ${token}',
...
class StatusesCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      callName: 'statuses',
      apiUrl: '${HappyGoAPIGroup.baseUrl}/statuses',
      callType: ApiCallType.GET,
      headers: {
        ...HappyGoAPIGroup.headers,
        'Authorization': 'Bearer ${token}',
    ...
    final ffApiRequestBody = '''
{
  "description": "${comment}"
    ...
    return ApiManager.instance.makeApiCall(
      callName: 'status',
      apiUrl: '${HappyGoAPIGroup.baseUrl}/order/${slug}/status/${status}',
      callType: ApiCallType.POST,
      headers: {
        ...HappyGoAPIGroup.headers,
        'Authorization': 'Bearer ${token}',
    ...
    final ffApiRequestBody = '''
{
  ...
  "data": {
    ...
    return ApiManager.instance.makeApiCall(
      callName: 'nextmodule',
      apiUrl: '${HappyGoAPIGroup.baseUrl}/products/next_module',
      callType: ApiCallType.POST,
      headers: {
        ...HappyGoAPIGroup.headers,
        'Authorization': 'Bearer ${token}',
...
class ModulesCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      callName: 'modules',
      apiUrl: '${HappyGoAPIGroup.baseUrl}/products/modules',
      callType: ApiCallType.GET,
      headers: {
        ...HappyGoAPIGroup.headers,
        'Authorization': 'Bearer ${token}',
...
class ScenariosCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      callName: 'scenarios',
      apiUrl: '${HappyGoAPIGroup.baseUrl}/products/scenarios',
      callType: ApiCallType.GET,
      headers: {
        ...HappyGoAPIGroup.headers,
        'Authorization': 'Bearer ${token}',
